...
CREATE TYPE "public"."audit_entity_type" AS ENUM('client', 'asset', 'debt', 'beneficiary', 'asset_allocation', 'business', 'key_person', 'shareholder', 'corporate_insurance_need', 'policy', 'user_profile');--> statement-breakpoint
