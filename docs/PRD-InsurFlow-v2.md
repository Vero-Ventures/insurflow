...
> Status note (2026-03-16): This document reflects the prior advisor-first/client-demo direction and is retained for historical reference only.
>
> Do not use this file for active scope or roadmap decisions. For the active Canadian consumer term life broker direction, use `docs/product-direction-alignment.md`.
